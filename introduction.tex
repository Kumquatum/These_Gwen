...
L'analyses de données de transcriptomiques par réseaux de co-expression nécessite elle-même des précautions et préparations spécifiques. Sur le plan de la normalisation, certaines normalisations de puce à ADN et de RNA-seq ne seront pas compatible avec l'analyse par co-expression telle que décrite dans la section suivante \cite{Zhang2005a}. 

\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\# SECTION EN TRAVAUX, SAUTER À LA SUIVANTE \#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#\#
% ###### NORMALISAITON
...
- Impact RNA-seq/microarray %  https://academic.oup.com/bioinformatics/article/29/6/717/184320
...
- Normalisation ? Laquelle? % microarray = mixed model (https://academic.oup.com/bioinformatics/article/21/7/1112/268967), rna-seq = pc correction (parsana 2019)
%Pourquoi utiliser les counts plutôt que les FPKM, TPM, etc.
