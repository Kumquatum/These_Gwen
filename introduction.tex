...
L'ARN est une molécule dont la stabilité est faible et la dégradation rapide en raison des nombreuses enzymes de dégradation la ciblant dans une cellule. Les technologies de transcriptomiques utilisent donc rarement les ARN en eux même et vont plutôt construire des ADN complémentaires (ADNc) de leurs séquences à l'aide de transcriptases reverse découvertes en 1970 \cite{Temin1970Jun}. 
...
Leur utilisation dans l'étude de l'expression des gènes va toutefois tendra à diminuer au profit de nouvelles technologies dites de "haut débit" capable de quantifier 
...
% L'ARN est une molécule dont la stabilité est faible et la dégradation rapide en raison des nombreuses enzymes de dégradation la ciblant dans une cellule. Les technologies de séquençages ont donc subit de nombreuses évolutions avant d'arriver à une précision suffisante pour analyser les séquences d'ARN et réaliser ces séquençages pour une grande quantité d'ARN. 

% Dans les années 70 et 80, les premiers séquençages de transcriptome partiel \cite{Jeppesen1970Apr} ou complet pour des organismes à ARN de petite taille \cite{Fiers1976Apr} ont été réalisés à l'aide d'enzymes de restriction produisant des fragments d'ARN ensuite migré sur des électrophorèses sur gel pour déterminer leur séquence. Malgré les découvertes permises par cette technique de lyse enzymatique, le temps requis et  vont progressivement entrainer un déclin de son utilisation au profit du séquençage Sanger \cite{Sanger1975May}. Développée en 1975 pour le séquençage génomique initialement, le séquençage Sanger et son essor ont su bénéficier à l'étude transcriptomique grâce au développement de la technique de transformation des ARN en ADN complémentaire (ADNc) \cite{Ying2004Jul} à l'aide de rétro-transcriptases \cite{Temin1970Jun}. Parallèlement, 

SAGE (\textit{Serial Analysis of Gene Expression})

% la limitation du nombre de nucléotides par séquence sur un gel et la toxicité des réactifs employés

% Cette technique étant longue et sujette à des erreur de lecture

% Dans les années 70 et 80 se sont développées les premières annotations de transcriptome partiel \cite{} ou complet pour des organismes à ARN tels que les bactériophages \cite{}. 
