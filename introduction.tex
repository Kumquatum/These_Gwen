...
% et peuvent être porteuses d'une pondération représentant une valeur de la connexion. 
...
\begin{align*}
    ...
    % I\left(1-\left|u_{i}\right|\right) &= 1\text{ si } 1-\left|u_{i}\right| > 0 \text{ et } 0 \text{ sinon} \\
    % \intertext{I\left(1-\left|u_{i}\right|\right) \text{ prend la valeur 1 si } 1-\left|u_{i}\right| > 0 \text{ et } 0 \text{ dans le cas contraire}} \\
...
En 1999, A. Barabasi et R. Albert découvrent une propriété de topologie à laquelle répondent la quasi-totalité des réseaux de très grande taille comme les interactions entre gènes : l'invariance d'échelle (en anglais \textit{scale-free}). 
