...
\todo{Faire figure basée sur https://www.researchgate.net/figure/Example-of-hierarchical-clustering-clusters-are-consecutively-merged-with-the-most_fig3_273456906}
...
Les modules tendent à regrouper des gènes aux fonctions physiologiques semblables ou co-régulées \cite{}. Une façon de comprendre la raison du regroupement de ces gènes est donc de leur rattacher une fonction, une voie d'activation, un tissu, une maladie dans laquelle ils interviennent. Cependant, les gènes œuvrant rarement à une seule fonction, ils se retrouvent annoté de plusieurs fonctions \cite{}. Des fonctions non pertinentes dans le contexte du module peuvent donc s'y retrouver associées. Pour estimer lesquelles sont réellement significatives dans chaque module, on effectue donc des tests d'enrichissement \cite{}. 


ORA / FCS / et le 3e dont j'ai oublié le nom
