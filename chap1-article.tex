...
\todo[inline]{Changer le résumé FR par un résumé de MAXIMUM 250 mots (exigence FESP)}
...
\end{tabular}
% }
\caption{Module 19 young enriched terms table. Multiple enrichment are linked to muscle development and growth}
