\chapter{Fichier additionnel au chapitre \ref{chapter:gwena}}
...
\begin{figure}[h!]
    \begin{adjustbox}{addcode={
        \begin{minipage}{\width}}{
            \caption{Here is a caption of the figure which is so long that it has to be wrapped over multiple lines, but should not exceed the width (height after the rotation) of the image.
